...
int CreateBMPFile(LPCTSTR pszFile, HBITMAP hBitmap, HDC hDC) {
    ...
    // Create the .BMP file.  
    hf = CreateFile(pszFile, GENERIC_WRITE, (DWORD)0, NULL, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, (HANDLE)NULL);
